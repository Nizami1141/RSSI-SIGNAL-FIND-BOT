...
# --- MISSION GOALS ---
# The robot will stop when it calculates it is between 2.5m and 3.5m
TARGET_DISTANCE_M = 3.0   # The ideal distance we want
DIST_TOLERANCE = 0.5      # +/- 0.5 meters (So 2.5m to 3.5m is acceptable)
        ...
        try:
            while True:
                ...
                # This is the "Threshold" Logic
                    ...
                    print(f"\n🎉 I FOUND YOU! Distance is {estimated_meters:.2f}m (Goal was 2.5-3.5m)")
                    break
